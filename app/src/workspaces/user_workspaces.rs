...
impl UserWorkspaces {
    ...
    /// Local-only builds do not use Warp billing/workspace entitlement checks; users can
    /// always configure provider keys for locally routed AI requests.
    ...
    /// Local-only builds allow user-owned OpenAI-compatible endpoints without Warp plans.
